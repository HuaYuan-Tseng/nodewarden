    ...
    constructor() {
        ...
        this.locales = {
            zh: {
                ...
                title: '🛡️ 安全審計與透明度報告',
                grade: '安全評級',
                important: '> [!IMPORTANT]\n> 本報告由 **GitHub Actions** 自動生成。為確保資料主權的絕對透明度，所有核心模組的安全掃描結果均實時公開。',
                auditTime: '📅 審計時間',
                runId: '📝 執行 ID',
                env: '🛠️ 環境',
                dashboard: '📉 實時安全儀表盤',
                ...
                vulns: '漏洞',
                alerts: '告警',
                coverageTitle: '🔍 掃描覆蓋範圍',
                module: '模組',
                auditedFiles: '已審計檔案',
                coverage: '覆蓋率',
                detailedFindings: '🔍 詳細發現項',
                gitleaksTitle: '🔑 憑據洩露檢查 (Gitleaks)',
                gitleaksDesc: '`檢測程式碼歷史記錄中硬編碼的 API 金鑰、密碼或其他敏感令牌。`',
                gitleaksSafe: '✅ **安全**：未發現硬編碼的敏感憑據。',
                gitleaksScope: '`掃描範圍：所有程式碼更改和 Git 歷史記錄 (Gitleaks 全量掃描)`',
                snykTitle: '📦 第三方依賴',
                snykSafe: '✅ **安全**：在依賴項中未發現已知漏洞。',
                package: '軟體包',
                severity: '嚴重程度',
                description: '描述',
                fixPlan: '修復方案',
                codeqlTitle: '💻 程式碼質量與安全 (CodeQL)',
                codeqlSummary: '#### 摘要',
                rulesChecked: '已檢查規則',
                totalAlerts: '告警總數',
                codeqlSafe: '✅ **安全**：CodeQL 掃描清潔，未檢測到問題。',
                ruleId: '規則 ID',
                level: '級別',
                location: '位置',
                auditedList: '📂 已審計檔案列表',
                guideTitle: '⚠️ 操作指南',
                guideDesc: '如果您看到 **FAIL** 狀態或嚴重的程式碼問題：',
                guideStep1: '1. **開發人員**：使用上方表格中的 **位置** 列找到確切的檔案和行號。',
                guideStep2: '2. **糾正**：遵循為每個規則提供的文件連結以提交修復。',
                guideStep3: '3. **可追溯性**：完整的原始 `.sarif` 資料已附加到此分支。下載並將其匯入您的 IDE（例如 VS Code SARIF 檢視器）進行本地分析。',
                footer: '💡 *由 Antigravity AI 安全引擎生成。透明度是我們的承諾。*',
                auditedIcon: '✅ **已審計**',
                noFiles: '未檢索到檔案。',
                trivyTitle: '🛡️ 容器配置安全 (Trivy)',
                trivyDesc: '`檢測 Dockerfile 和容器配置中的安全風險與最佳實踐。`',
                trivySafe: '✅ **安全**：未發現容器配置缺陷。'
            },
            en: {
